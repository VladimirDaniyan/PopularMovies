...
public class TextAndImageListFragment extends ListFragment {

	private static final String KEY_POSITION = "position";
	private static final String TAG = "TMDB Pop Movies";

	private static final String apiKey = "?api_key=57983e31fb435df4df77afb854740ea9";
	...
	private class DownloadJSON extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... url) {
			json = JSONParser.getJSONfromURL(tmdbURL + "/3/movie/popular"
					+ apiKey);
	...
	void openWebView(int position) {
		String movieURL = "http://www.themoviedb.org/movie/"
				+ mylist.get(position).get(TAG_ID);
		...
		Log.d(TAG, "movie id is " + mylist.get(position).get(TAG_ID));
	}
